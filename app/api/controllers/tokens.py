...
from app.api.controllers.helpers import api_error, api_response, require_api_token
...
@bp.get(
    ...
    description="Returns all API tokens for the authenticated customer, including scopes and usage timestamps. Requires `mail:read` scope.",
    responses={"200": TokenListResponse, "401": ErrorResponse},
)
...
@bp.delete(
    ...
    description="Permanently revokes an API token by ID. The token can no longer be used for authentication after revocation. Requires `mail:write` scope.",
