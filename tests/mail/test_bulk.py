...
class TestBulkDeleteProtection:
    ...
    def test_bulk_delete_skips_starred_message(self, app, authed_client):
        ...
        with (
            patch("app.modules.mail.controllers.bulk.open_cache", return_value=MagicMock()),
            patch("app.modules.mail.controllers.bulk.get_message", return_value=protected_msg),
            patch(
                "app.modules.mail.controllers.bulk._get_or_create_settings",
                return_value=_protect_starred_settings(),
            ),
            patch(
                "app.modules.mail.controllers.bulk._imap_for_account",
    ...
    def test_bulk_delete_skips_locked_message(self, app, authed_client):
        ...
        with (
            patch("app.modules.mail.controllers.bulk.open_cache", return_value=MagicMock()),
            patch(
                "app.modules.mail.controllers.bulk.get_message",
                return_value=_msg_with_flags(["$Locked"]),
            ),
            patch(
                "app.modules.mail.controllers.bulk._get_or_create_settings",
                return_value=_protect_starred_settings(),
    ...
    def test_bulk_delete_unprotected_message_proceeds(self, app, authed_client):
        ...
        with (
            ...
            patch(
                "app.modules.mail.controllers.bulk.get_message",
                return_value=_msg_with_flags(["\\Seen"]),
            ),
            patch(
                "app.modules.mail.controllers.bulk._get_or_create_settings",
                return_value=_protect_starred_settings(),
    ...
    def test_bulk_move_to_trash_skips_protected(self, app, authed_client):
        ...
        with (
            ...
            patch(
                "app.modules.mail.controllers.bulk.get_message",
                return_value=_msg_with_flags(["\\Flagged"]),
            ),
            patch(
                "app.modules.mail.controllers.bulk._get_or_create_settings",
                return_value=_protect_starred_settings(),
