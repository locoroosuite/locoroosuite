...
def register(app):
    from app.modules.mail.controllers import auth, mailbox, message, compose, search, settings, tags, sse, bulk, api_settings, twofa_settings, attachments  # noqa: F401 (side-effect: registers routes)
